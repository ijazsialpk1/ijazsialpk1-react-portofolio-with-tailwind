...
import ijaz from "../public/ijaz.png";
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between dark:text-white">
            <h1 className="font-burtons text-xl">Ijaz Sial</h1>
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-gray-400">
              ...
              <Link href={"https://twitter.com/web4crypto_io"}>
                <a target={'_blank'}>
                <AiFillTwitterCircle />
                </a>
              </Link>
              
              <Link href={"https://www.linkedin.com/in/ijaz-sial-b76621176/"}>
                <a target={'_blank'}>
                <  AiFillLinkedin />
                </a>
              </Link>
              <Link href={"https://www.youtube.com/c/Web4Crypto"}>
                <a target={'_blank'}>
                < AiFillYoutube />
                </a>
              </Link>
        ...
        <section>
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              ...
              programming and also wordpress.
            </p>
          </div>
        ...
        <section className="py-10">
          <div>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-gray-200">
              I offer from a wide range of services, including brand design,
              programming and also wordrpess.
            </p>
          </div>
